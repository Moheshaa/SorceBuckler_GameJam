...
public class DialogueManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        DialogueTrigger instance = new DialogueTrigger();
        instance.TriggerDialogue();
        DisplayNextSentence();
    ...
    public void StartDialogue(Dialogue dialogue)
    {
        ...
        root.sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[1].sentences[0] = new Dialogue(1, "???", "Nonsense, we’re glad to have you here! You can call me Sluglie, darling.", 2);
        ...
        root.sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0] = new Dialogue(1, "Rocky", "Well I’ve got nothing else going for me... I might as well be a student here!", 1);
        root.sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[1].sentences[0].sentences[0] = new Dialogue(1, "Rocky", "Well I’ve got nothing else going for me... I might as well be a student here!", 1);
        root.sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[2].sentences[0].sentences[0] = new Dialogue(1, "Rocky", "Well I’ve got nothing else going for me... I might as well be a student here!", 1);
    ...
    public void DisplayNextSentence()
    {
        ...
        {
            profPic.gameObject.SetActive(false);
            EndDialogue();
        ...
        else
        {
            ...
            switch(currDialogue.sentences[0].id)
            {
                case 0:
                    ...
                    break;
                case 1:
                    profPic.gameObject.SetActive(true);
            ...
            if (currDialogue.sentences[0].dialogue == "There’s a large turnout at the campus movie event for Bass Lives. It’s a sad movie, and you notice Axolola crying next to you.")
                background.GetComponent<Image>().sprite = bg2;
            else if (currDialogue.sentences[0].dialogue == "Time passes and you are hard at work, studying in the university library. This SEA ES assignment is rather difficult.")
                background.GetComponent<Image>().sprite = bg4;
            else if (currDialogue.sentences[0].dialogue == "Midterms have passed, and you get your results back. It turns out that you hadn’t studied enough for Marine Bio 101, and you ended up failing your exam.")
                background.GetComponent<Image>().sprite = bg6;
            StopAllCoroutines();
            ...
            if (currDialogue.sentences[0].dialogue == "END" || currDialogue.sentences[0].dialogue == "END1" )
            {
                ...
                {
                    DateTime();
                    background.GetComponent<Image>().sprite = bg7;
                }
                else
                {
                    TalktoChars();
            ...
            else if(currDialogue.sentences[0].dialogue == "FIN")
            {
    ...
    {
        background.GetComponent<Image>().sprite = bg1;
        axoTalk = true;
        ...
        cont.sentences[0].sentences[0] = new Dialogue(2, "Axolola", "It’s just so sad! I can’t believe they don’t end up together!", 0);
    ...
    {
        background.GetComponent<Image>().sprite = bg3;
        blobTalk = true;
        ...
        root.sentences[0].sentences[0].sentences[0] = new Dialogue(3, "Blobert", "It’s so lonely here...", 0);
        ...
        root.sentences[0].sentences[0].sentences[0].sentences[1].sentences[0] = new Dialogue(2, "Blobert", "I’m actually an international student, I’m from Australia. There’s no other fishes from there here...", 0);
        ...
        cont.sentences[0].sentences[0].sentences[0] = new Dialogue(1, "Blobert", "Sure thing, mate! See all you have to do is this...", 3);
        ...
        cont.sentences[0].sentences[1].sentences[0] = new Dialogue(2, "Blobert", "I reckon you’re having a tough time there; do you need any help?", 0);
        ...
        cont.sentences[0].sentences[1].sentences[0].sentences[0].sentences[0] = new Dialogue(1, "Blobert", "Sure thing, mate! See all you have to do is this...", 3);
    ...
    {
        background.GetComponent<Image>().sprite = bg5;
        slugTalk = true;
        Dialogue root = new Dialogue(1, "", "", 0);
        ...
        root.sentences[0].sentences[0] = new Dialogue(3, "Sluglie", "Hey, do you want to go get mud facials with me?", 0);
        ...
        root.sentences[0].sentences[0].sentences[1].sentences[0] = new Dialogue(2, "Sluglie", "Well even if you can’t reap the benefits, it’ll be a nice break from school!", 0);
        ...
        cont.sentences[0] = new Dialogue(3, "Sluglie", "Do you need a hug right now? You know, I always say some self-affirmations to myself to pick myself up when I’m feeling down in the depths.", 0);
        ...
        cont.sentences[0].sentences[1].sentences[0] = new Dialogue(2, "Sluglie", "You know, stuff like ‘I’m strong, I am worthy, I am more than enough!’", 0);
    ...
    public void axoDate()
    {
        ...
        root.sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0] = new Dialogue(1, "", "But remember, all relationships are the result of meaningful time shared together. There's a whole sea out there, and you feel hopeful about meeting all the fish you possibly can.", 0);
        root.sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0] = new Dialogue(1, "", "FIN", 0);
        ...
        root.sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[1].sentences[0].sentences[0] = new Dialogue(1, "", "But remember, all relationships are the result of meaningful time shared together. There's a whole sea out there, and you feel hopeful about meeting all the fish you possibly can.", 0);
        root.sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[1].sentences[0].sentences[0].sentences[0] = new Dialogue(1, "", "FIN", 0);

        root.sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[2] = new Dialogue(1, "", "“Water monster” in Nahuatl", 0);
        root.sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[2].sentences[0] = new Dialogue(1, "", "Now that you think about it, you know more about Axolola than the average fish does.", 0);
        root.sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[2].sentences[0].sentences[0] = new Dialogue(1, "", "Mustering up all the courage you can, you turn to her.", 0);
        root.sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[2].sentences[0].sentences[0].sentences[0] = new Dialogue(1, "Rocky", "Axolola?", 1);
        root.sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[2].sentences[0].sentences[0].sentences[0].sentences[0] = new Dialogue(1, "Axolola", "Yes, Rocky?", 2);
        root.sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[2].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0] = new Dialogue(1, "Rocky", "I’m so glad to have gotten to know you...you’ve taught me how to be vulnerable. I’ve never really done that before, and I’m a better rock now because I was able to be your friend.", 1);
        root.sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[2].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0] = new Dialogue(1, "Rocky", "Will you be my forever fish?", 1);
        root.sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[2].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0] = new Dialogue(1, "Axolola", "You...you really mean it? Oh gosh, that’s the nicest thing anyone’s ever said to me! Of course I will be your forever fish!", 2);
        root.sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[2].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0] = new Dialogue(1, "", "The two of you share a special moment together under the aquarium lights as you dream about a future together.", 0);
        root.sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[2].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0] = new Dialogue(1, "", "FIN", 0);
        ...
        root.sentences[0].sentences[0].sentences[0].sentences[1].sentences[0].sentences[0] = new Dialogue(1, "", "But remember, all relationships are the result of meaningful time shared together. There's a whole sea out there, and you feel hopeful about meeting all the fish you possibly can.", 0);
        root.sentences[0].sentences[0].sentences[0].sentences[1].sentences[0].sentences[0].sentences[0] = new Dialogue(1, "", "FIN", 0);
        ...
        root.sentences[0].sentences[0].sentences[0].sentences[2].sentences[0].sentences[0] = new Dialogue(1, "", "But remember, all relationships are the result of meaningful time shared together. There's a whole sea out there, and you feel hopeful about meeting all the fish you possibly can.", 0);
        root.sentences[0].sentences[0].sentences[0].sentences[2].sentences[0].sentences[0].sentences[0] = new Dialogue(1, "", "FIN", 0);
    ...
    public void slugDate()
    {
        ...
        root.sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0] = new Dialogue(1, "", "But remember, all relationships are the result of meaningful time shared together. There's a whole sea out there, and you feel hopeful about meeting all the fish you possibly can.", 0);
        root.sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0] = new Dialogue(1, "", "FIN", 0);
        ...
        root.sentences[0].sentences[0].sentences[0].sentences[1].sentences[0].sentences[2].sentences[0].sentences[0] = new Dialogue(1, "", "But remember, all relationships are the result of meaningful time shared together. There's a whole sea out there, and you feel hopeful about meeting all the fish you possibly can.", 0);
        root.sentences[0].sentences[0].sentences[0].sentences[1].sentences[0].sentences[2].sentences[0].sentences[0].sentences[0] = new Dialogue(1, "", "FIN", 0);
        ...
        root.sentences[0].sentences[0].sentences[0].sentences[1].sentences[0].sentences[1].sentences[0].sentences[0] = new Dialogue(1, "", "But remember, all relationships are the result of meaningful time shared together. There's a whole sea out there, and you feel hopeful about meeting all the fish you possibly can.", 0);
        root.sentences[0].sentences[0].sentences[0].sentences[1].sentences[0].sentences[1].sentences[0].sentences[0].sentences[0] = new Dialogue(1, "", "FIN", 0);
        ...
        root.sentences[0].sentences[0].sentences[0].sentences[1].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0] = new Dialogue(1, "", "FIN", 0);
    ...
    public void blobDate()
    {
        ...
        root.sentences[0].sentences[0].sentences[0].sentences[1].sentences[0].sentences[0].sentences[0].sentences[0] = new Dialogue(1, "", "But remember, all relationships are the result of meaningful time shared together. There's a whole sea out there, and you feel hopeful about meeting all the fish you possibly can.", 0);
        root.sentences[0].sentences[0].sentences[0].sentences[1].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0] = new Dialogue(1, "", "FIN", 0);
        ...
        root.sentences[0].sentences[0].sentences[0].sentences[1].sentences[0].sentences[2].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0].sentences[0] = new Dialogue(1, "", "FIN", 0);
